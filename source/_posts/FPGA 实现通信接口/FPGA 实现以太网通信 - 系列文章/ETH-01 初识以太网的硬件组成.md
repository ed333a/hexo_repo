...
### 以太网通信的硬件组成
下面是一张硬件组成图例
![以太网通信的硬件组成](../../../img/fpga_impl_interface/ethernet_impl/eth-01/ethernet_hardware_components.png)
...
![GMII 接口](../../../img/fpga_impl_interface/ethernet_impl/eth-01/gmii_interface.png)
...
![RGMII 接口](../../../img/fpga_impl_interface/ethernet_impl/eth-01/rgmii_interface.png)
...
![UDP 通信模块框图](../../../img/fpga_impl_interface/ethernet_impl/eth-01/udp_module_diagram.png)
