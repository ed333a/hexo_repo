...
![MDIO 读数据时序图](../../img/fpga_impl_interface/eth_mdio/mdio_reading.png)
![MDIO 读数据时序图-note](../../img/fpga_impl_interface/eth_mdio/mdio_reading_note.png)
#### 写数据
| Preamble | ST  |   OP   | PHYAD | REGAD |   TA   |       DATA       | IDLE |
| :------: | :-: | :----: | :---: | :---: | :----: | :--------------: | :--: |
|  1...1   | 01  | **01** | AAAAA | RRRRR | **10** | DDDDDDDDDDDDDDDD |  Z   |
在写数据时，MDIO 总线**全程由主设备控制**
![MDIO 写数据时序图](../../img/fpga_impl_interface/eth_mdio/mdio_writing.png)
### 实现代码
#### 双向 IO 口的驱动
