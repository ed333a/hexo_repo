...
![ARP 协议图](../../../img/fpga_impl_interface/ethernet_impl/eth-04/arp_block_diagram.png)
...
![ARP 协议 MAC 帧](../../../img/fpga_impl_interface/ethernet_impl/eth-04/arp_format_mac.png)
#### ARP 数据报格式
ARP 数据报位于以太网帧中的数据段中，它的格式如下图所示。
![ARP 数据报格式](../../../img/fpga_impl_interface/ethernet_impl/eth-04/arp_format.png)
