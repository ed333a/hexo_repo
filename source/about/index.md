...
> 欢迎你来到我的博客！这是一个使用 [Hexo](https://hexo.io/zh-cn/) 框架搭建的技术博客。现有主题基于 [Butterfly](https://github.com/jerryc127/hexo-theme-butterfly) 方案做了修改。目前小站还有很多缺点和不足，甚至在配色上还有很多问题……但已经在改变的路上，希望大家多多包涵~
>
...
<div class="about_header">
    <style>
        .about_header {
            ...
            margin: 60px 0;
            background: linear-gradient(45deg, #00fff5 0%, #7e00ff 100%);
            padding: 40px;
            border-radius: 16px;
            color: white;
    ...
    <h1 style="color: #242424;">  ✨关于我自己✨ </h1>
    <p style="color: #dfd; font-size: 18px;"> 分享单片机、FPGA开发，和PCB设计经验，记录嵌入式开发路上的成长点滴。 </p>
</div>
